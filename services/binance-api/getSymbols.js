...
function getData(responseString) {
    ...
    objResult = popularSymbols(objResult, 10)                        // (JSON), (0 mayor-menor, 1 menor-mayor), (Cantidad de symbolos a mostrar).
...
function popularSymbols(obj, quantity, ascendingOrder = false) {
    if (ascendingOrder) {
